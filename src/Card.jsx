                ...
                <div className="col-lg-12 mb-4">
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <a href="http://www.google.com" without rel="noreferrer" target="_blank" className="btn btn-outline-primary btn-sm">
                                Google link</a>
                        </div>
                    </div>
                </div>
